// [V3.7 S4] tb_cpu_v35mem_poc.sv より自動複製 (mk_v37_tb.py v1.0 / 2026-07-12)
//   変更点: membus を ysd8800_v37_membus_v0_1 に差し替え、
//           YSD8004割込ポートを接続(割込源は0固定)。判定内容は同一。
//   目的  : V3.7統合による V3.5相当機能のデグレ検出（回帰）
// ============================================================
//  tb_cpu_v35mem_poc.sv   (V3.5 regression PoC / KY38)
//  元TB: tb_cpu_v3mem_v0_1.sv

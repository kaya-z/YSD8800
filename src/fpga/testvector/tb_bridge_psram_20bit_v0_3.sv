// ============================================================
//  tb_bridge_psram_20bit_v0_3.sv   v0.3  (2026-08-26)
//  ★正式版★ 工程①.5（PSRAM性能改善）DUT追従版
//    v0.3 変更点: DUT参照を ysd8800_cdc_bridge_v0_3 → ★v0_4★ へ追従。
//                 (①.5 A-2q＝suppress_r方式／死状態変数ack_sync_d除去)
//                 ★TB本体のロジック・ベクタは無改修★(23ベクタのまま)。
//                 回帰結果: ALL PASS (23 vectors) — 2026-08-26 実測。
//    v0.2 変更点: DUT参照を v0_2 → v0_3 へ追従（A-2q適用）。
//    ------------------------------------------------------------
//    以下 v0.1 の記録(欠落させない)
//  tb_bridge_psram_20bit_v0_1.sv   v0.1  (2026-07-11)
//  YSD8800 FPGA V3.5 : CDCブリッジ~~v0.2~~→★v0.4★ + PSRAMコントローラv0.2
//                      ★20bit物理アドレス貫通の検証★
//
//  対象: ysd8800_cdc_bridge_v0_4.sv (★v0.4★)
...
module tb_bridge_psram_20bit_v0_3;

#!/bin/bash
# build_v0_10_11.sh — kernel_forth_i3_load.fs をビルドする
...
#   - kernel_forth_i3_load.fs が同じディレクトリに存在
#
...
SRC="kernel_forth_i3_load.fs"
ASM="kernel_forth_i3_load.asm"
...
for sym in WORD_MEMMGR_TASK WORD_UART_DRV_TASK WORD_UART_TEST_TASK \
           ...
           WORD_I3_ECHO_SERVER_TASK WORD_I3_LOAD_TASK; do

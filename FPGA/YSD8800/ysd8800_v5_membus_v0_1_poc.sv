// ============================================================
//  ysd8800_v5_membus_v0_1_poc.sv   v0.1  (2026-07-14)
...
module ysd8800_v5_membus_v0_1_poc #(
    ...
    // ============================================================
    // (2) MMIOスタブ ★v0.5_poc★ … MMUレジスタ(PTR/MCR) + YSD8004
    //                              + YSD8001 + ★YSD8002★
    ...
    // ============================================================
    ysd8800_mmio_stub_v0_5_poc u_mmio_stub (

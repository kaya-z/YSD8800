// ============================================================
//  ysd8800_mmio_stub_v0_5_poc.sv   v0.5  (2026-07-14 / 2026-07-17 irq0_ack経路再適用)
...
module ysd8800_mmio_stub_v0_5_poc (
    input  logic        clk,
    input  logic        rst_n,
    ...
    // ------------------------------------------------------------
    logic hit_ptr, hit_mcr, hit_ys4, hit_ys1, hit_ys2;
    ...
    ysd8800_ysd8002_v0_2_poc u_ysd8002 (
        .clk         (clk),
        .rst_n       (rst_n),
        // MMIOルーティング: 本デバイスがヒットした時のみ sel を上げる

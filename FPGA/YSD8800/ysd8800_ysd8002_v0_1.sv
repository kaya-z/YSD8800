// ============================================================
//  ysd8800_ysd8002_v0_1.sv   v0.1  (2026-07-14)
//  ★本番昇格版★ (実験は ysd8800_ysd8002_poc.sv にて実施・KY38)
...
module ysd8800_ysd8002_v0_1 (
    ...
    //  ★1クロックパルス★ 組合せで出す(fire は次クロックで armed_r=0 により落ちる)
    assign irq_timer_o = fire;

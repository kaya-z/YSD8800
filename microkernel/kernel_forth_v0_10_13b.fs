...
$C800 CONSTANT PAGE-POOL-BASE   \ ページプール先頭  v0.10.12 案C: $C000→$C800
24    CONSTANT PAGE-TOTAL        \ 総ページ数        v0.10.12 案C: 32→24（$C800-$DFFF/256）
20    CONSTANT PAGE-USER-MAX     \ ユーザ用ページ数  v0.10.12 案C: 28→20（24中OS予約4除く）
$FFF0 CONSTANT PAGE-BMP-HI-INIT \ HI初期値 v0.10.12 案C: $F000→$FFF0
                                \ HI=page16-31。$FFF0=bit4-15=1：
                                \   page20-23(bit4-7)=OS予約4page、
                                \   page24-31(bit8-15)=無効page恒久使用中マーク
...
\ ページビットマップ初期化
\ page 0-15: 全空き（$0000）
\ page 16-19: 空き、page 20-23: OS予約、page24-31: 無効(BMP-HI-INIT=$FFF0)  v0.10.12 案C
: BMP-INIT  ( -- )
    0                PAGE-BMP-LO !

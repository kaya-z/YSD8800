...
int main(int argc, char **argv) {
    ...
    while (fgets(linebuf, sizeof(linebuf), fp)) {
        ...
        if (strcmp(mnem, "LDB") == 0 || strcmp(mnem, "STB") == 0) {
            ...
            char *comma = strchr(p, ',');
            if (!comma) {
                fprintf(stderr, "%s expects reg,[..] at line %d\n", mnem, lineno);
                return 1;
            }
            *comma = 0;
            strcpy(regpart, trim(p));
            strcpy(addrpart, trim(comma + 1));
    ...
    while (fgets(linebuf, sizeof(linebuf), fp)) {
        ...
        if (strcmp(mnem, "PUSH") == 0 || strcmp(mnem, "POP") == 0) {
            ...
            if (strcmp(mnem, "PUSH") == 0) {
                if      (strcmp(op1, "A") == 0) sub = 0x00;
                else if (strcmp(op1, "B") == 0) sub = 0x01;
                else if (strcmp(op1, "X") == 0) sub = 0x02;
            } else {
                if      (strcmp(op1, "A") == 0) sub = 0x03;
                else if (strcmp(op1, "B") == 0) sub = 0x04;
                else if (strcmp(op1, "X") == 0) sub = 0x05;
            }
            if (sub < 0) {
                fprintf(stderr, "Invalid operand for %s at line %d\n", mnem, lineno);
                return 1;
        ...
        if (strcmp(mnem, "LDB") == 0 || strcmp(mnem, "STB") == 0) {
            ...
            *comma = 0;
            ...
            if (!is_A && !is_B) {
                fprintf(stderr, "LDB/STB only support A or B at line %d\n", lineno);
                return 1;
            }

            if (reg >= 0) {
                if (strcmp(mnem, "LDB") == 0) {
                ...
                if (sub < 0) {
                    fprintf(stderr, "Unsupported reg/[X] combination at line %d\n", lineno);
                    return 1;
                }
                fputc(0x1F, fb);
                fputc(sub, fb);
                ...
                if (sub < 0) {
                    fprintf(stderr, "Unsupported reg/[addr] combination at line %d\n", lineno);
                    return 1;
                }
    ...
    printf("Assembled: %s  (v2.11: ISA2.1 EXT + LDW/STW + EQU/DW/DB + #$LABEL/#E000)\n", outbin);
    return 0;
}

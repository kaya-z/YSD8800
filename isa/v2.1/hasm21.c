// hasm21.c - YSD8800 ISA2.1 Assembler v1.00
//
...
int main(int argc, char **argv) {
    if (argc < 2) {
        fprintf(stderr, "usage: hasm21 file.asm\n"
                        "  ISA2.1 assembler for YSD8800\n"
                        "  Extensions over ISA2.0:\n"
                        "    PUSH/POP A|B|X\n"
                        "    LDB/STB  A|B, [addr] | [X]\n");
        return 1;
    }
    ...
    printf("hasm21: assembled '%s' -> %s  (ISA2.1 / EXT PUSH/POP/LDB/STB)\n",
           argv[1], outbin);
    return 0;
}

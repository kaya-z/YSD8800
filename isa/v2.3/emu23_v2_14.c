// emu23_v2_14.c v2.14 (2026-08-22): [MW-1 REPL照合の構造是正 + MW-2 ダンプ経路の非対称是正]
...
static void trace_write_header(void)
{
    if (!trace_fp) return;
    fprintf(trace_fp,
            "# emu23 v2.14 trace / mc=%d lat=F%u,R%u,W%u,FILL%u"
...
int main(int argc, char **argv) {
    ...
    if (argc < 2) {
        fprintf(stderr,
            "emu23 v2.14 (2026-08-22) for YSD8800 ISA2.3\n"
    ...
    printf("YSD8800 ISA2.3 Emulator (emu23 v2.14%s) — reset vector = %04x\n",
           mmu_mode ? " +MMU" : "", cpu.pc);

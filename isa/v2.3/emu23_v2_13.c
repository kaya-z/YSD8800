// emu23_v2_13.c v2.13 (2026-08-22): [任意アドレス書き込み機能 + dbg_access]
...
static void trace_write_header(void)
{
    if (!trace_fp) return;
    fprintf(trace_fp,
            "# emu23 v2.13 trace / mc=%d lat=F%u,R%u,W%u,FILL%u"
...
int main(int argc, char **argv) {
    ...
    if (argc < 2) {
        fprintf(stderr,
            "emu23 v2.13 (2026-08-22) for YSD8800 ISA2.3\n"
    ...
    printf("YSD8800 ISA2.3 Emulator (emu23 v2.13%s) — reset vector = %04x\n",
           mmu_mode ? " +MMU" : "", cpu.pc);

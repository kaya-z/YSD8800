...
Version 1.4  /  2026-05-03（最終改版: 2026-05-24）
...
| 関連設計書 | emu23_v103_design_v1_4.docx (emu23 改修)、emu23_device_design_v1_2.docx (YSD8003 仕様)、yuios_ph3_uart_design_v1_2.docx (Ph.3-A5 UART 設計)、yuios_ph4_filemgr_design_v1_2.md (Ph.4 FileMgr 設計) |
| 上位設計書 | yuios_design_v2_0.docx §6.3 ストレージドライバ |
| 作成日 | 2026-05-03 |
| ステータス | v1.4（v1.3 FIX に加え Ph.4 LBA 配置整合修正反映済み） |

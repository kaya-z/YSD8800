...
| 4 | `scc23_v2_04.c` | `scc23` |
| 5 | `emu23_v111.c` | `emu23` |
...
| # | ファイル | 備考 |
|---|---|---|
| 14 | `Makefile` | v1.2（`KERN_SRC=kernel_v12_8.asm`） |
...
| # | ファイル | 備考 |
|---|---|---|
| 17 | `kernel_v12_8.asm` | カーネル（V5 TCR-ACK 対応版） |
...
gcc -O2 -o scc23  scc23_v2_04.c
gcc -O2 -o emu23  emu23_v111.c -lm
```
...
| 18 | `sd_image.hex` | プロジェクトナレッジからそのままコピー（8,192 行） |

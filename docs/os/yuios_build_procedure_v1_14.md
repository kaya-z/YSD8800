YUI OS ビルド手順書 v1.14 / 2026-08-14

**YUI OS ビルド手順書**

~~yuios_build_procedure_v1_12.docx~~ → ~~yuios_build_procedure_v1_13.md~~ → **yuios_build_procedure_v1_14.md**（★v1.13で拡張子を実体に合わせ `.md` へ是正。v1.12までは `.docx` でありながら実体はUTF-8プレーンテキストだった＝KY41 4点整合）

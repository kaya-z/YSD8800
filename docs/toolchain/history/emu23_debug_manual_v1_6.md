...
emu23 v2.00 / ISA 2.3 対応

対応エミュレータバージョン: emu23 v2.00 (2026-08-18)

| 文書番号 | EMU23-DEBUG-MANUAL-001 |
| --- | --- |
| 文書バージョン | **v1.6**（2026-08-18） ~~v1.5（2026-08-17）~~ ~~v1.4（2026-08-14）~~ |
| 作成日 | 2026-05-17 |
| 改版日 | 2026-08-18 |
| 作成者 | YSD8800開発チーム |
| 対象エミュレータ | **emu23 v2.00** (ISA2.3対応) ~~v1.14~~ ~~v1.12~~ ~~v1.09~~ |
| ファイル名 | ~~emu23_debug_manual_v1_2.docx~~ → **emu23_debug_manual_v1_5.md**（★v1.3 で拡張子を実体に合わせ `.md` へ是正★ v1.2 までは `.docx` でありながら実体は UTF-8 プレーンテキストだった＝KY41 4点整合） |
...
| | `-mc` 無し（既定） | `-mc` あり |
| --- | --- | --- |
| cycles | **48,785** | 351,761 |
| Dhrystones/sec | **819** | 113 |
| 判定 | **P:20** | P:20 |

**実効 CPI は約 7.21**（351,761 ÷ 48,785）。
つまり **FPGA 実機は emu23 の既定表示より約 7.2 倍の時間がかかる**と見積もれます。

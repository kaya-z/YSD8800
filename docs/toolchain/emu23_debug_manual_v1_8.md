...
emu23 v2.13 / ISA 2.3 対応

対応エミュレータバージョン: emu23 v2.13 (2026-08-22)

| 文書番号 | EMU23-DEBUG-MANUAL-001 |
| --- | --- |
| 文書バージョン | **v1.8**（2026-08-22） ~~v1.7（2026-08-21）~~ ~~v1.6（2026-08-18）~~ ~~v1.5（2026-08-17）~~ ~~v1.4（2026-08-14）~~ |
| 作成日 | 2026-05-17 |
| 改版日 | 2026-08-22 |
| 作成者 | YSD8800開発チーム |
| 対象エミュレータ | **emu23 v2.13** (ISA2.3対応) ~~v2.12~~ ~~v2.11~~ ~~v2.00~~ ~~v1.14~~ ~~v1.12~~ ~~v1.09~~ |
| ファイル名 | ~~emu23_debug_manual_v1_2.docx~~ ~~emu23_debug_manual_v1_5.md~~ ~~emu23_debug_manual_v1_7.md~~ → **emu23_debug_manual_v1_8.md**（★v1.3 で拡張子を実体に合わせ `.md` へ是正★ v1.2 までは `.docx` でありながら実体は UTF-8 プレーンテキストだった＝KY41 4点整合） |
| 関連設計書 | **emu23_memwrite_design_v0_4.md** / **emu23_cache_base_design_v1_0.md** / **emu23_device_design_v1_11.md** / **emu23_interactive_mode_design_v1_6.md** / ~~emu23_interactive_mode_design_v1_2.md~~ / emu23_v108_mmu_port_design_v1_1.md / emu23_v105_design_v1_0.md / emu23_v103_design_v1_4.md / emu23_device_design_v1_3.docx |
| ステータス | 確定 |
...
| **★`memw` は MMIO の読み出し副作用を起こす★**（**是正起票済 MW-2**） | `memw $FC80` は **UART 受信 FIFO を進める**。v2.13 で課金汚染は解消したが**副作用は残る**（→§3.6.6）。MMIO 帯の確認には `mem` を使うこと |

/* scc23_v2_00.c - Small C Compiler for YSD8800 ISA2.3
 * Version: 2.00 (2026-06-22)
 *
 ...
 * バージョン
 * ============================================================ */
#define SCC_VERSION   "2.00"
#define SCC_DATE      "2026-06-22"
...
static void emit_runtime(void) {
    ...
    emit("    RET");
    emit("_fdiv_nz:");
    emit("    STW  A, [_C_MUL_A]");        /* WN = a */
    emit("    STW  B, [_C_MUL_B]");        /* WD = b */
    emit("    LDW  A, #0");

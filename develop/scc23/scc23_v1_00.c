/* scc23_v1_00.c - Small C Compiler for YSD8800 ISA2.3
 ...
 *   [X-4]  = ローカル変数2
 *
 * build: gcc -std=c99 -O2 -Wall scc23_v1_00.c -o scc23
 * usage: scc23 [-o output.asm] input.c
 */

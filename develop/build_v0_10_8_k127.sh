#!/bin/bash
# build_v0_10_8.sh — kernel_forth_v0_10_8.fs をビルドする
# v0.10.8: Step 5-4 FILE-CLOSE-IMPL 実装版
#
# 前提:
...
#   - kernel_forth_v0_10_8.fs が同じディレクトリに存在
#
# 既存の build.sh (v0.10.2 系専用) を v0.10.8 向けに派生したもの。
# build.sh のタグ式 (v0.10.2{tag}) を踏襲せず、明示的に v0.10.8 を扱う。

set -e

SRC="kernel_forth_v0_10_8.fs"
ASM="kernel_forth_v0_10_8.asm"
KASM="kernel_v12_7_for_v0_10_8.asm"
BIN="yuios_v0_10_8.bin"
SYM="yuios_v0_10_8.sym"
LDS="yuios_v0_10_8.lds"

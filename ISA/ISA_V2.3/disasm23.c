// disasm23.c - YSD8800 ISA2.3 Disassembler
// disasm23 v1.00 (2026-04-16)
//
...
//   - hasm23 で再アセンブル可能なソース形式で出力
//   - ベクタテーブル（$0000-$000F）を .vector ディレクティブで出力
//   - ゼロ埋め領域は .org でスキップ
//
// 使用法:
//   disasm23 file.bin [options]
//   disasm23 file.bin --sym file.sym --dbg file.dbg
//   disasm23 file.bin --start 0x0030 --end 0x01BF
//   disasm23 file.bin -o output.asm
//
//   .sym / .dbg は指定がなければ file.bin から自動検出
//
// build: gcc -std=c99 -O2 -Wall disasm23.c -o disasm23
...
static int decode(uint16_t pc, char *buf, size_t bsz) {
    ...
    case 0x05: snprintf(buf,bsz,"SYSCALL");                              return 1;  // ISA2.3: 1バイト
...
static void usage(const char *prog) {
    fprintf(stderr,
        "YSD8800 ISA2.3 Disassembler - disasm23 v1.00 (2026-04-16)\n"
...
int main(int argc, char **argv) {
    ...
    fprintf(out, "; disasm23 v1.00  ISA2.3 disassembler\n");
    ...
    fprintf(stderr, "disasm23: %s [%04X-%04X]  sym=%d  dbg=%d%s\n",

YUI OS Ph.3 UART ドライバ詳細設計書 v1.2

**YUI OS Ph.3 UART ドライバ詳細設計書**

yuios_ph3_uart_design_v1_2.docx

Version 1.3  /  2026-05-01（最終改版: 2026-05-18）
...
| 対象エミュレータ | emu23 v1.02 |
| 関連設計書 | yuios_design_v2_0.docx / ysd8001_uart_design_v1_2.docx |
| 前提引継ぎ | HANDOVER_CHAT19.docx |
| 作成日 | 2026-05-01 |
| 作成者 | Claude (Anthropic) |
| ステータス | v1.2 FIX（review8 GO + 実装ルール正式記載） |
...
| A4 | DSP から r0/r1/r2/r3 を順に pop し、TCB+16/+18/+20/+22 へ書込 | r0=byte（rx_pop 結果）、r1/r2/r3=0 を直接書込（DSP 経由しない） |

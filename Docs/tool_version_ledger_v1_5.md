...
| **emu23** | **v1.07** | **emu23_v107.c** | エミュレータ（UART/Timer/SD/IRQ統合 + stack watermark計測） | **v1.07: Step 8-I IRQ優先制御修正（IRET時のタイマー再設定をタイマーIRQ復帰時のみに限定＝§5.3準拠）。タイマー欠落テスト v1.06=1→v1.07=983。Dhrystone 回帰 826/48405/P:20 一致** |

#!/bin/bash
# build_v0_10_17.sh — Ph.6 Shell phase1/2版
# ベース: build_v0_10_15.sh。Step3 sedリストに WORD_SHELL_TASK 追加(申1)。
set -e
SRC="${1:-kernel_forth_v0_10_18.fs}"
ASM="kf_build.asm"
KASM="kf_build_kern.asm"
BIN="yuios_build.bin"
SYM="yuios_build.sym"
LDS="yuios_build.lds"
...
for sym in WORD_MEMMGR_TASK WORD_UART_DRV_TASK WORD_UART_TEST_TASK \
           ...
           WORD_FILEMGR_TEST_TASK WORD_PROCMGR_TASK WORD_SHELL_TASK; do

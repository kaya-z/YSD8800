#!/bin/bash
# build_v0_10_5.sh — kernel_forth_v0_10_5.fs をビルドする
# v0.10.5: Step 5-4 FILE-CLOSE-IMPL 実装版
#
# 前提:
...
#   - kernel_forth_v0_10_5.fs が同じディレクトリに存在
#
# 既存の build.sh (v0.10.2 系専用) を v0.10.5 向けに派生したもの。
# build.sh のタグ式 (v0.10.2{tag}) を踏襲せず、明示的に v0.10.5 を扱う。

set -e

SRC="kernel_forth_v0_10_5.fs"
ASM="kernel_forth_v0_10_5.asm"
KASM="kernel_v12_5_for_v0_10_5.asm"
BIN="yuios_v0_10_5.bin"
SYM="yuios_v0_10_5.sym"
LDS="yuios_v0_10_5.lds"
